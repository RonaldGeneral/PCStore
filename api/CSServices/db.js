...
async function checkDatabaseAndCreateTable() {
  ...
  query('CREATE TABLE IF NOT EXISTS csweb.`message` (`id` int(11) PRIMARY KEY NOT NULL AUTO_INCREMENT,`phone` varchar(255) DEFAULT NULL,`message` varchar(1000) DEFAULT NULL,`created_at` DATETIME NULL DEFAULT current_timestamp());');
